...
Here is the complete Markdown documentation for the automated bash script that successfully solves the entire lab.

### How to use this solution:

1. Open **Google Cloud Shell**.
2. Create a new file named `solution.sh` using the nano editor:
```bash
nano solution.sh
...
7. **Important:** As the script runs, it will prompt you for the specific dynamic names generated for your lab instance (e.g., Zone, Cluster name, Monolith image identifier). Copy these values directly from your Qwiklabs instruction panel and paste them into the terminal when asked.

---

### The Automation Script (`solution.sh`)
